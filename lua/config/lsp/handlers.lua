...
local function lsp_keymaps(bufnr)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "R", "<cmd>Lspsaga hover_doc<CR>", opts)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>q", "<cmd>Trouble loclist<CR>", opts)
	vim.cmd([[ command! Format execute 'lua vim.lsp.buf.formatting()' ]])
end

M.on_attach = function(client, bufnr)
	if client.name == "tsserver" or client.name == "sumneko_lua" or client.name == "json-ls" then
